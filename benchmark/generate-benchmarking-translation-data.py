...
# Function to Process and Translate Files
def process_files(input_folder: str, output_folder_xl8: str, output_folder_openai: str,
    ...
    for file_name in os.listdir(input_folder):
        if file_name.endswith(".txt"):
            ...
            xl8_output_path = os.path.join(output_folder_xl8, file_name)
            ...
            openai_output_path = os.path.join(output_folder_openai, file_name)
            with open(openai_output_path, "w", encoding="utf-8") as file:
                file.write(openai_translation)

            print(f"Translated '{file_name}' -> Saved to XL8 and OpenAI folders.")

# Main Execution
if __name__ == "__main__":
    input_folder = "./subtitles"  # Folder containing subtitle files
    ...
    process_files(input_folder, output_folder_xl8, output_folder_openai, source_language, target_language)
